...
from audiad.music.models import Genre, Song
from audiad.music.tables import GenreTable as GT
from audiad.music.forms import GenreForm
...
class GenreTable(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if not self.request.user.is_authenticated():
            ...
            context = super(GenreTable, self).get_context_data(**kwargs)
            table = GT(Genre.objects.all())
    ...
    def get(self, request, filter_by='all'):
        ...
        if not request.user.is_authenticated():
            ...
            try:
                ...
                genres = []
            return render(request, 'music/genre/genre_list.html', {
                'object_list': genres,
                'filter_by': filter_by,
            })
