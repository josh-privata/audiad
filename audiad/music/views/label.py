...
from audiad.music.models import Label
from audiad.music.tables import LabelTable as LT
from audiad.music.forms import LabelForm
    ...
    def get(self, request, filter_by='all'):
        ...
        if not request.user.is_authenticated():
            ...
            try:
                ...
                labels = []
            return render(request, 'music/label/label_list.html', {
                'object_list': labels,
                'filter_by': filter_by,
            })


class LabelTable(ListView):
    """docstring
    ...
    def get_context_data(self, **kwargs):
        ...
        if not self.request.user.is_authenticated():
            ...
            context = super(LabelTable, self).get_context_data(**kwargs)
            table = LT(Label.objects.all())
