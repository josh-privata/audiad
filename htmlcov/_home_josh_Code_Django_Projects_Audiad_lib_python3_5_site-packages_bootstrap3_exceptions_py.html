...
<head>
    ...
    <title>Coverage for /home/josh/Code/Django/Projects/Audiad/lib/python3.5/site-packages/bootstrap3/exceptions.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/josh/Code/Django/Projects/Audiad/lib/python3.5/site-packages/bootstrap3/exceptions.py</b> :
...
<p id="t5" class="stm run hide_run"><span class="key">class</span> <span class="nam">BootstrapException</span><span class="op">(</span><span class="nam">Exception</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t6" class="pln">    <span class="str">"""</span><span class="strut">&nbsp;</span></p>
<p id="t7" class="pln"><span class="str">    Any exception from this package</span><span class="strut">&nbsp;</span></p>
...
<p id="t12" class="stm run hide_run"><span class="key">class</span> <span class="nam">BootstrapError</span><span class="op">(</span><span class="nam">BootstrapException</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t13" class="pln">    <span class="str">"""</span><span class="strut">&nbsp;</span></p>
<p id="t14" class="pln"><span class="str">    Any exception that is an error</span><span class="strut">&nbsp;</span></p>
